class Event:
    ...
    def __repr__(self):
        return f'{type(self).__name__}(title="{self.title}", start_date={self.start_date}, duration={self.duration},' \
               f' localization="{self.localization}", owner="{self.owner}", members={self.members})'


# e = Event(title="browarek", start_date="2021-05-05", duration=50, localization="Krakow", owner="Andrzej", members=[])
# print(e)
# print(repr(e))